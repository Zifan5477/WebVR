 ...
 <div id="head">
  ...
  <div class="nav">
   <ul>
	...
	<li {if $_lang.customvip}class="noRight"{/if}><a target="_blank" href="https://shop104464789.taobao.com/?spm=2013.1.1000126.d21.v1D86b">使用文档</a></li>
    {if !$_lang.customvip}<li class="noRight"><a target="_blank" href="https://shop104464789.taobao.com/?spm=2013.1.1000126.d21.v1D86b">购买官网</a></li>{/if}
   </ul>
