...
FileProgress.prototype.setChunkProgess = function(chunk_size) {
    ...
    var viewProgess = $('<button class="btn btn-default" onclick="javascript:$(\'.chunk-status-tr\').toggle()">查看分块上传进度</button>');
...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    var showImg = $('<img src="/static/images/loading-sm.gif"/>');
